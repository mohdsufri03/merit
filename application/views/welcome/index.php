<?php $this->load->view('coming_soon');?>
<!--<!DOCTYPE html>-->
<!--<html lang="en" >-->
<!--<head>-->
...
<!--        <?php //$this->load->view('includes/sidebar',array('active'=>6));?>-->
...
<!--									<div class="row text-truncate">-->
										<!-- BEGIN col-6 -->
<!--										<div class="col-6">-->
<!--											<div class=" text-gray-200">Total sales order</div>-->
...
<!--										</div>-->
										...
										<!-- BEGIN col-6 -->
<!--										<div class="col-6">-->
<!--											<div class=" text-gray-200">Avg. sales per order</div>-->
...
<!--										</div>-->
<!--										<div class="d-flex align-items-center ms-auto">-->
<!--											<div class="small text-gray-200"><i class="fa fa-caret-up"></i> <span data-animation="number" data-value="25.7">0.00</span>%</div>-->
...
<!--										</div>-->
<!--										<div class="d-flex align-items-center ms-auto">-->
<!--											<div class="small text-gray-200"><i class="fa fa-caret-up"></i> <span data-animation="number" data-value="16.0">0.00</span>%</div>-->
...
<!--										</div>-->
<!--										<div class="d-flex align-items-center ms-auto">-->
<!--											<div class="small text-gray-200"><i class="fa fa-caret-up"></i> <span data-animation="number" data-value="7.9">0.00</span>%</div>-->
...
<!--										<div class="ms-auto text-gray-200"><span data-animation="number" data-value="39.85">0.00</span>%</div>-->
<!--									</div>-->
<!--								</div>-->
<!--								<div class="d-flex align-items-center text-white mb-2">-->
...
<!--									<div class="d-flex w-100">-->
<!--										<div>China</div>-->
<!--										<div class="ms-auto text-gray-200"><span data-animation="number" data-value="14.23">0.00</span>%</div>-->
<!--									</div>-->
<!--								</div>-->
<!--								<div class="d-flex align-items-center text-white mb-2">-->
...
<!--									<div class="d-flex w-100">-->
<!--										<div>Germany</div>-->
<!--										<div class="ms-auto text-gray-200"><span data-animation="number" data-value="12.83">0.00</span>%</div>-->
<!--									</div>-->
<!--								</div>-->
<!--								<div class="d-flex align-items-center text-white mb-2">-->
...
<!--									<div class="d-flex w-100">-->
<!--										<div>France</div>-->
<!--										<div class="ms-auto text-gray-200"><span data-animation="number" data-value="11.14">0.00</span>%</div>-->
<!--									</div>-->
<!--								</div>-->
...
<!--									<div class="d-flex w-100">-->
<!--										<div>Japan</div>-->
<!--										<div class="ms-auto text-gray-200"><span data-animation="number" data-value="10.75">0.00</span>%</div>-->
<!--									</div>-->
<!--								</div>-->
<!--							</div>-->
<!--						</div>-->
...
<!--								</div>-->
<!--								<div class="widget-list-action text-nowrap text-gray-200">-->
...
<!--									<div class="mb-2px  small">Mon 12/6 - Sun 18/6</div>-->
...
<!--									</div>-->
<!--									<div class=" small mb-15px text-truncate">-->
...
<!--									<div class="mb-2px  small">Sat 10/6 - Sun 18/6</div>-->
<!--									<div class="d-flex align-items-center mb-2px">-->
<!--										<div class="flex-grow-1">-->
<!--											<div class="progress h-5px rounded-pill bg-white bg-opacity-10">-->
