        ...
        <!-- BEGIN content-container -->
            <div class="app-content-padding flex-grow-1 overflow-hidden" data-scrollbar="true" data-height="100%">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">SENARAI KOD KESALAHAN</a></li>
                </ol>
                <!-- END breadcrumb -->
				<!-- BEGIN page-header -->
                <h1 class="page-header">KOD KESALAHAN<small></small></h1>
                <!-- END page-header -->
                
                <!-- BEGIN panel -->
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                        <h4 class="panel-title">SENARAI KOD KESALAHAN</h4>
                        <div class="panel-heading-btn">
                            <a href="<?php echo site_url('student/create')?>" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> New Kod</a>
                        </div>
                      </div>
                        ...
                        <table class="table mb-0">
                            <thead class="bg-200 text-900">
                              <tr>
                                ...
                                <th>No</th>
								<th>Jenis Kod Kesalahan</th>
								<th>Nombor Kod Kesalahan</th>
                          ...
                          <tbody><?php foreach($student_data as $student):?>
							<tr>
								...
								<td class="align-middle"><?php echo $student->plug_customer_jenis_kod_kesalahan ?></td>
								<td class="align-middle"><?php echo $student->plug_customer_nombor_kod_kesalahan ?></td>
