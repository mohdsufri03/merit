...
<html>
    ...
    <body>
        ...
        <table class="table">
	    <tr><td>Plug Customer Jenis kod kesalahan </td><td><?php echo $plug_customer_jenis_kod_kesalahan; ?></td></tr>
	    <tr><td>Plug Customer Nombor kod kesalahan</td><td><?php echo $plug_customer_nombor_kod_kesalahan; ?></td></tr>
