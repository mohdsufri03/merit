...
<body>
  ...
  <div class="app app-header-fixed app-sidebar-fixed app-content-full-height" id="app">
    <!-- BEGIN #header -->
    <?php $this->load->view('includes/top_nav');?><?php $this->load->view('includes/sidebar');?><!-- BEGIN #content -->
            ...
            <div class="panel-body">
              <form action="<?php echo site_url('mod_meta/child_create_action')?>" id="form_submit" method="post" name="form_submit">
                <div class="row mb-15px">
                  <label class="form-label col-form-label col-md-3">Meta Key</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="mod_meta_key" type="text" value="<?php echo $id?>" id="mod_meta_key">
                  </div>
                </div>
                <div class="row mb-15px">
                  <label class="form-label col-form-label col-md-3">Meta Name</label>
                  <div class="col-sm-6">
