	...
	<div id="app" class="app">
		...
		<div class="login login-with-news-feed">
			...
			<div class="login-container">
				<!-- BEGIN login-header -->
				<div class="login-header mb-30px text-center">
				    <div class="brand">
				...
				<div class="login-content">
					<form id="form" method="post" class="fs-13px">
						...
						<div class="form-check mb-30px">
							...
							<a href="Register"class = "ca"> create an account </a>
							<a href="Register"class = "ca"> register </a>
							

							</label>
						</div>
						<div class="mb-15px">
							<button id="form-submit" type="button" class="btn btn-success d-block h-45px w-100 btn-lg fs-14px">Sign in</button>
						</div>
